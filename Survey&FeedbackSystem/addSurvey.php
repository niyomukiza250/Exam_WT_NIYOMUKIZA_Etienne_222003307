...
<body> <div class="header">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO Surveys (Title, Description, CreatorID, StartDate, EndDate) VALUES (?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssiss", $title, $description, $creatorID, $startDate, $endDate);

        if ($stmt->execute()) {
            echo "<div class='container'><p>New survey created successfully.</p></div>";
            echo "<script>
                alert('New survey created successfully');
                window.location.href='viewSurvey.php?msg=New survey created successfully';
                </script>";
        } else {
