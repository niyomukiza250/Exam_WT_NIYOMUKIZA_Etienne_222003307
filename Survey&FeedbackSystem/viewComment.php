...
<head>
    ...
    <title>Feedback Comment Management</title>
...
<header> 
    <div class="header">
        ...
        <h1>Feedback Comment Management</h1>
        <div class="profile">
...
<main>
    ...
    <br><br><br>
    <!-- Table for displaying feedback comments -->
    <table id="commentTable" class="table table-hover text-center">
        <tr>
            <th>Comment ID</th>
            <th>Response</th>
            <th>Comment Text</th>
        ...
        <?php
        // Fetch data from the FeedbackComment table
        $sql = "SELECT FeedbackComment.CommentID, Responses.Answer, 
                       FeedbackComment.CommentText, FeedbackComment.CommentDate, User.UserName 
                FROM FeedbackComment
                JOIN Responses ON FeedbackComment.ResponseID = Responses.ResponseID
                JOIN User ON FeedbackComment.CommenterID = User.UserID";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                // Edit action
                echo "<a href='edit_comment.php?updateID=" . $row["CommentID"] . "'><i class='fas fa-edit'></i></a>";
                // Delete action
                echo "<a href='delete_comment.php?deleteID=" . $row["CommentID"] . "'><i class='fas fa-trash'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
...
<div class="footer">
    &copy; 2024 Feedback Comment Management
</div>

<script>
function printTable() {
    var divToPrint = document.getElementById("commentTable");
    var newWin = window.open("");
    newWin.document.write('<html><head><title>Print Feedback Comment Records</title>');
