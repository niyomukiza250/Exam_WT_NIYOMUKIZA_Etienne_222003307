...
<main>
    ...
    <table id="responseTable" class="table table-hover text-center">
        ...
        <?php
        // Fetch data from the Responses, User, Surveys, and Questions tables
        $sql = "SELECT r.ResponseID, CONCAT(u.FirstName, ' ', u.LastName) as RespondentName, s.Title as SurveyTitle, q.QuestionText, r.Answer, r.ResponseDate 
                FROM Responses r 
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                // Edit action
                echo "<a href='edit_response.php?updateID=" . $row["ResponseID"] . "'><i class='fas fa-edit'></i></a>";
                // Delete action
                echo "<a href='delete_response.php?deleteID=" . $row["ResponseID"] . "'><i class='fas fa-trash'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
