...
<main>
    <h2>Currently Available Surveys
    ...
    <br><br><br>
    <!-- Table for displaying surveys -->
    <table id="surveyTable" class="table table-hover text-center">
        <tr>
            <th>Survey ID</th>
            <th>Title</th>
            <th>Description</th>
        ...
        <?php
        // Fetch data from the Surveys table
        $sql = "SELECT s.SurveyID, s.Title, s.Description, u.UserName as CreatorName, s.StartDate, s.EndDate 
                FROM Surveys s 
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                // Edit action
                echo "<a href='edit_survey.php?updateID=" . $row["SurveyID"] . "'><i class='fas fa-edit'></i></a>";
                // Delete action
                echo "<a href='delete_survey.php?deleteID=" . $row["SurveyID"] . "'><i class='fas fa-trash'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
