...
<head>
    ...
    <title>Feedback Category Management</title>
...
<header> 
    <div class="header">
        ...
        <h1>Feedback Category Management</h1>
        <div class="profile">
...
<main>
    ...
    <br><br><br>
    <!-- Table for displaying feedback categories -->
    <table id="categoryTable" class="table table-hover text-center">
        ...
        <?php
        // Fetch data from the FeedbackCategory table
        $sql = "SELECT * FROM FeedbackCategory";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                // Edit action
                echo "<a href='edit_category.php?updateID=" . $row["CategoryID"] . "'><i class='fas fa-edit'></i></a>";
                // Delete action
                echo "<a href='delete_category.php?deleteID=" . $row["CategoryID"] . "'><i class='fas fa-trash'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
...
<div class="footer">
    &copy; 2024 Feedback Category Management
</div>

<script>
function printTable() {
    var divToPrint = document.getElementById("categoryTable");
    var newWin = window.open("");
    newWin.document.write('<html><head><title>Print Feedback Category Records</title>');
