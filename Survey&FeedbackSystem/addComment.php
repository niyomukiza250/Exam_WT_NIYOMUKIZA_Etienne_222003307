...
<head>
    ...
    <title>Add Feedback Comment</title>
    <style>
        /* General Styles */
        body {
...
<body> <div class="header">
    ...
    <div class="container">
        ...
        <form action="addComment.php" method="post">
            ...
            <div class="form-group">
                <label for="commenterID">Commenter Name:</label>
                <select id="commenterID" name="commenterID" required>
                    <?php
                    // Database connection parameters
                    $servername = "localhost";
                    $username = "root";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Insert data into FeedbackComment table
        $sql = "INSERT INTO FeedbackComment (ResponseID, CommentText, CommentDate, CommenterID) VALUES (?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("issi", $responseID, $commentText, $commentDate, $commenterID);

        if ($stmt->execute()) {
            echo "<div class='container'><p>New comment added successfully.</p></div>";
            echo "<script>
                alert('New comment added successfully');
                window.location.href='viewComment.php?msg=New comment added successfully';
                </script>";
        } else {
