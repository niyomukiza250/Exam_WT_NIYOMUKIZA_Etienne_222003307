...
<main>
    <h2>Currently Available Questions
    ...
    <table id="questionTable" class="table table-hover text-center">
        <tr>
            <th>Question ID</th>
            <th>Survey</th>
            <th>Question Text</th>
        ...
        <?php
        // Fetch data from the Questions and Surveys tables
        $sql = "SELECT q.QuestionID, s.Title as SurveyTitle, q.QuestionText, q.QuestionType, q.Sequence 
                FROM Questions q 
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                // Edit action
                echo "<a href='edit_question.php?updateID=" . $row["QuestionID"] . "'><i class='fas fa-edit'></i></a>";
                // Delete action
                echo "<a href='delete_question.php?deleteID=" . $row["QuestionID"] . "'><i class='fas fa-trash'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
...
<script>
function printTable() {
    var divToPrint = document.getElementById("questionTable");
    var newWin = window.open("");
    newWin.document.write('<html><head><title>Print Question Records</title>');
