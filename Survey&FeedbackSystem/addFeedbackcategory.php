...
<head>
    ...
    <title>Create New Feedback Category</title>
    <style>
        /* General Styles */
        body {
...
<body> <div class="header">
    ...
    <div class="container">
        ...
        <form action="addFeedbackcategory.php" method="post">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Insert data into FeedbackCategory table
        $sql = "INSERT INTO FeedbackCategory (CategoryName, Description) VALUES (?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ss", $categoryName, $description);

        if ($stmt->execute()) {
            echo "<div class='container'><p>New feedback category created successfully.</p></div>";
            echo "<script>
                alert('New feedback category created successfully');
                window.location.href='viewFeedbackcategory.php?msg=New feedback category created successfully';
                </script>";
        } else {
